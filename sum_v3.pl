...
# 
$sh->scp("$dir_result/coleta_cti_up_geral.txt","root\@10.98.22.11:$dir_result/coleta_cti_up_geral.txt");
$sh->scp("$dir_result/coleta_cti_dn_geral.txt","root\@10.98.22.11:$dir_result/coleta_cti_dn_geral.txt");
$sh->scp("$dir_result/coleta_cti_err_geral.txt","root\@10.98.22.11:$dir_result/coleta_cti_err_geral.txt");
$sh->scp("$dir_result/coleta_cti_trf_geral.txt","root\@10.98.22.11:$dir_result/coleta_cti_trf_geral.txt");
$sh->scp("$dir_result/coleta_cti_crc_geral.txt","root\@10.98.22.11:$dir_result/coleta_cti_crc_geral.txt");
$sh->scp("$dir_result/coleta_geral.txt","root\@10.98.22.11:$dir_result/coleta_geral.txt");
$sh->scp("$dir_result/total_cti_geral.txt","root\@10.98.22.11:$dir_result/total_cti_geral.txt");
