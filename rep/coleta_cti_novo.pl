...
open(coletag,"</coleta_crc/cti/coleta_geral.txt");

@coleta_geral=<coletag>;

close(coletag);

open(coletag1,"/coleta_crc/cti/coleta_geral.txt");
...
#print "$hostname ; $amb ; $cli;\$ $serv;$usuario;$crit\n";

#$sql_inc="insert into coleta_interfaces (hostname,interface,status,protocolo_st,descr,dcd,dsr,dtr,rts,cts,lt_clear,pkt_in,bytes_in,pkt_out,bytes_out,in_err,out_err,collisions,int_reset,drops,crc,data_inc,amb,cli,site,serv,usuario,crit) VALUES ('$hostname','$int_s','$int_status','$protocolo_st','$descr','$dcd','$dsr','$dtr','$rts','$cts','$lt_clear','$pkt_in','$bytes_in','$pkt_out','$bytes_out','$input_error','$out_err','$collissions','$int_resets','$total_drop','$crc_x','$data_reg','$amb','$cli','$site','$serv','$usuario','$crit')";

#executa sql de update ou insert

#$dbh->do("$sql_inc");

###############fim insere na base########################################

#         print tac_brad "$hostname\t$int\t$descr\t$dcd\t$dsr\t$dtr\t$rts\t$cts\t$lt_clear\t$pkt_in\t$bytes_in\t$pkt_out\t$bytes_out\t$out_err\t$input_error\t$collisions\t$int_resets\t$total_drop\t$crc_x\n";

if ($int_status=~/up/ and $protocolo_st=~/up/){

print coleta_up "$t;$dt;$hostname;$int_s;$int_status / $protocolo_st;$descr;$dcd;$dsr;$dtr;$rts;$cts;$lt_clear;$pkt_in;$bytes_in;$pkt_out;$bytes_out;$input_error;$out_err;$collissions;$int_resets;$total_drop;$crc_x;$data_reg;$amb;$cli;$site;$serv;$usuario;$crit\n";
...
if ($int_status=~/down/ or $protocolo_st=~/down/){
   ...
   print coleta_dn "$t;$dt;$hostname;$int_s;$int_status / $protocolo_st;$descr;$dcd;$dsr;$dtr;$rts;$cts;$lt_clear;$pkt_in;$bytes_in;$pkt_out;$bytes_out;$input_error;$out_err;$collissions;$int_resets;$total_drop;$crc_x;$data_reg;$amb;$cli;$site;$serv;$usuario;$crit\n";
...
print coleta_err "$t;$dt;$hostname;$int_s;$int_status / $protocolo_st;$descr;$dcd;$dsr;$dtr;$rts;$cts;$lt_clear;$pkt_in;$bytes_in;$pkt_out;$bytes_out;$input_error;$out_err;$collissions;$int_resets;$total_drop;$crc_x;$data_reg;$amb;$cli;$site;$serv;$usuario;$crit;crc\n";
...
#print coleta_err "$t;$dt;$hostname;$int_s;$int_status / $protocolo_st;$descr;$dcd;$dsr;$dtr;$rts;$cts;$lt_clear;$pkt_in;$bytes_in;$pkt_out;$bytes_out;$input_error;$out_err;$collissions;$int_resets;$total_drop;$crc_x;$data_reg;$amb;$cli;$site;$serv;$usuario;$crit;err_int\n";
...
print coleta_err "$t;$dt;$hostname;$int_s;$int_status / $protocolo_st;$descr;$dcd;$dsr;$dtr;$rts;$cts;$lt_clear;$pkt_in;$bytes_in;$pkt_out;$bytes_out;$input_error;$out_err;$collissions;$int_resets;$total_drop;$crc_x;$data_reg;$amb;$cli;$site;$serv;$usuario;$crit;resets\n";
...
print total_cti "$t;$dt;$up;-;$conta_err;$dn";
#close(tac_brad);
close(coleta_up);
close(coleta_dn);
close(coleta_err);
